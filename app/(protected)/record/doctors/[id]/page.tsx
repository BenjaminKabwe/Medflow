...
const STR = {
  fr: {
    ...
    doctorAppointments: "Rendez-vous du médecin",
...
const DoctorProfile = async (props: { params: Promise<{ id: string }> }) => {
  ...
  return (
    <div className="bg-gray-100/60 dark:bg-[hsl(196,34%,9%)] h-full rounded-xl py-6 px-3 2xl:px-5 flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            <div className="doctorCard">
              ...
              <div>
                ...
                <span className="text-sm text-gray-500 dark:text-slate-400">{t.appointments}</span>
              </div>
            </div>
            <div className="doctorCard">
              ...
              <div>
                ...
                <span className="text-sm text-gray-500 dark:text-slate-400">{t.workingDays}</span>
              </div>
            </div>
            ...
            <div className="doctorCard">
              ...
              <div>
                ...
                <span className="text-sm text-gray-500 dark:text-slate-400">{t.workingHours}</span>
              </div>
            </div>
            <div className="doctorCard">
              ...
              <div>
                ...
                <span className="text-sm text-gray-500 dark:text-slate-400">{t.joinDate}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-[30%] flex flex-col gap-4">
        <div className="bg-white dark:bg-slate-900 p-4 rounded-md border border-slate-100 dark:border-slate-800">
          <h1 className="text-xl font-semibold text-slate-800 dark:text-slate-100">{t.quickLinks}</h1>
